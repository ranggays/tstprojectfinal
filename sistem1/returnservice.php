                 ...
                 <div class="services__container grid">
                    ...
                    <div class="services__container grid">
                        <div class="services__card">
                            ...
                            <h3 class="services__title">Return Product</h3>
                            <div class="content">
                            <form method="POST" action="process_return.php">
                                <label for="identifier">Enter Order ID or Resi Number:</label><br><br>
                                <input type="text" id="identifier" name="identifier" required><br><br>
                                <button type="submit" name="action" value="check">Check Details</button><br><br>
                                <button type="submit" name="action" value="create">Create Return Request</button>
                            </form>
                            </div>
                        </div>
                    </div>
