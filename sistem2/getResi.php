...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Cek apakah ID checkout ada di sistem1_db
    ...
    if ($result1->num_rows > 0) {
        ...
        // Cek apakah nomor resi sudah ada di sistem2_db
                        ...
                        <div class="services__card">
                            ...
                            <div class="content">
                                <form method="POST" class="form">
                                    ...
                                    <br><br>
                                    <?php if ($resi): ?>
                                        <!-- <p><strong>Nomor Resi:</strong> <?php echo $resi; ?> </p> -->
                                        <?php if ($message === "Data berhasil disimpan dengan nomor resi: $resi" || strpos($message, 'sudah disimpan') !== false): ?>
